...
from particle_classification.experiments.neural_separator.training import (
...
from particle_classification.experiments.neural_separator.model import (
    EdgeTrackNetTiny,
...
ASSET_DIR = ROOT / "experimental_notes" / "assets" / "phase1_dbscan_replacement"
REPORT_PATH = ROOT / "experimental_notes" / "phase1_neural" / "phase1-dbscan-replacement-report.md"
...
def build_report(
    *,
    ...
    lines = [
        ...
        "",
        "```bash",
        "python scripts/legacy/generate_phase1_report.py",
        "```",
        "",
    ]
    return "\n".join(lines)
