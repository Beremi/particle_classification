...
from particle_classification.experiments.neural_separator.model import EdgeTrackNetTiny, EdgeTrackNetTinyConfig


ROOT = Path(__file__).resolve().parents[2]
DOC = ROOT / "experimental_notes" / "phase1_neural" / "phase1-nn-full-report.md"
ASSETS = ROOT / "experimental_notes" / "assets" / "phase1_nn_full_report"
