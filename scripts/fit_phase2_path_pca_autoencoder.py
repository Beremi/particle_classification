...
def main() -> None:
    ...
    lines = [
        ...
        "",
        "The design follows the local `variable_hit_nn_report.pdf` guidance to keep variable hit sets and ToT/energy-aware reconstruction, while using the XY-invariant report rule that `theta_xy` is metadata, not class/shape latent. "
